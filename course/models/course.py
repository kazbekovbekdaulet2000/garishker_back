...
class Course(AbstractModel):
    ...
    duriation = models.DurationField(
        _("Длительность курса"), blank=True, null=False, default="7 00:00:00")
    ...
    teaser = models.FileField(_('Тизер'), upload_to=course_teaser_dir,
                              blank=True, storage=ClientDocsStorage, null=True)
    image = models.FileField(
        _('Обложка'), upload_to='course-image', blank=True)
    rating = models.DecimalField(
        _('Оценка'), max_digits=3, decimal_places=2, default=0)
