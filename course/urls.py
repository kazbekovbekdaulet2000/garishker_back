...
from course.views.lessons_view import LessonCurrent, LessonDetail, LessonList
...
urlpatterns = [
     ...
     path('<int:id>/participate/', CourseParticipation.as_view(lookup_url_kwarg='id', model=Course)),
