    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(20), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_kk', models.TextField(blank=True, verbose_name='Описание (рус)')),
                ('description_ru', models.TextField(blank=True, verbose_name='Описание (рус)')),
                ('file', models.FileField(blank=True, storage=config.yandex_storage.ClientDocsStorage, upload_to=course.models.resource.course_dir, verbose_name='Файл')),
                ...
                ('lesson_module', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='course.lessonmodule')),
            ],
            options={
                'verbose_name': 'Ресурс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', models.PositiveIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(20), django.core.validators.MinValueValidator(0)])),
